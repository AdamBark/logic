...
METADATA = {
    ...
    'description':      'A game of binary logic for PyWeek 18',
    'author':           'Adam Bark (PyTM30)',
    #'author_email':     '',
...
_DATA_DIR = os.path.join('logic', 'data')
data = []
...
data_dirs = [os.path.join(f2.replace(_DATA_DIR, 'data')) for f2 in data]
PACKAGEDATA['package_data'] = {'logic': data_dirs}
